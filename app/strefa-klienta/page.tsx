...
export default function StrefaKlientaStart() {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-blue-50 px-4"
        >
            <motion.form
                ...
                className="w-full max-w-md bg-white text-zinc-800 border border-zinc-200 px-8 py-10 shadow-xl"
            >
                ...
                <div className="flex flex-col space-y-2 mb-6">
                    ...
                    <input
                        ...
                        className="w-full bg-zinc-100 border border-zinc-300 text-zinc-800 px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-0 tracking-wide"
                    />
                </div>
                ...
                >
                    <Button
                        ...
                        className="w-full bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 font-semibold tracking-wide shadow transition uppercase"
                    >
